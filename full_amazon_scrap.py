...
def main():
    ...
    for item1 in range(0, len(item_list) - 1):
        ...
        for item2 in range(0, len(item_cat2) - 1):
            ...
            write_to_csv(file_name, item_cat2_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)
            ...
            for item3 in range(0, len(item_cat3) - 1):
                ...
                write_to_csv(file_name, item_cat3_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)
                ...
                for item4 in range(0, len(item_cat4) - 1):
                    ...
                    write_to_csv(file_name, item_cat4_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)
                    ...
                    for item5 in range(0, len(item_cat5) - 1):
                        ...
                        write_to_csv(file_name, item_cat5_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)

                        item_cat6 = html_parser(item_cat5_url)
                        for item6 in range(0, len(item_cat6) - 1):
                            item_cat6_url = item6.find('a').attrs['href']
                            cat6 = item6.text.strip()
                            write_to_csv(file_name, item_cat6_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)

                            item_cat7 = html_parser(item_cat6_url)
                            for item7 in range(0, len(item_cat7) - 1):
                                item_cat7_url = item7.find('a').attrs['href']
                                cat7 = item7.text.strip()
                                write_to_csv(file_name, item_cat7_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)

                                item_cat8 = html_parser(item_cat7_url)
                                for item8 in range(0, len(item_cat8) - 1):
                                    item_cat8_url = item8.find('a').attrs['href']
                                    cat8 = item8.text.strip()
                                    write_to_csv(file_name, item_cat8_url, cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8)
